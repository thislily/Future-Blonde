...
export function handleContactForm() {
  document.addEventListener("DOMContentLoaded", () => {
    ...
    form.addEventListener("submit", function (event) {
      ...
      const appPassword = "yourApplicationPassword"; // Replace with your actual application password
      ...
      fetch(
        `https://www.rainy-lily-days.one/wp-json/contact-form-7/v1/contact-forms/281/feedback`,
        {
          method: "POST",
