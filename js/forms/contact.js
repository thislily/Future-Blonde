...
//         } else {
//           throw new Error('There was a problem with your submission. Please try again.');
//         }
//       })
//       .catch((error) => {
//         console.error('Error:', error);
//         messageContainer.innerHTML = displayError(`An error occurred while submitting the form. ${error.message}`);
//       });
//     });
//   });
// }
